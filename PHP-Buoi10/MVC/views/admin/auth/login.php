...
<body class="align">
    <div class="grid">
        <form action="index.php?mod=admin&c=auth&act=checkLogin" method="POST" class="form login">        
            <div class="form__field">
                ...
                <input id="login__username" type="email" name="username" class="form__input" placeholder="Email" required>
            </div>            
            <div class="form__field">
