        ...
        <div class="container">
            ...
            <?php foreach($posts as $post) { ?>
                <tr>
                    ...
                    <td>
                        <a href="?mod=post&act=show&id=<?php echo $post['id'] ?>" class="btn btn-primary">Detail</a>
                        <a href="?mod=post&act=edit&id=<?php echo $post['id'] ?>" class="btn btn-success">Edit</a>
                        <a href="?mod=post&act=delete&id=<?php echo $post['id'] ?>" class="btn btn-danger">Delete</a>
                    </td>
                </tr>
            <?php } ?>
            </table>
